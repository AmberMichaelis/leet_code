/* Given head, the head of a linked list, determine if the linked list has a cycle in it (aka circular).
 *
...
var hasCycle = function (head) {
    ...
    while (first && last) {
        first = first.next;
        last = last.next ? last.next.next : undefined;
...
/* Explanation:
 * Using two pointers check if any of the nodes refer to a previous node.
 */
